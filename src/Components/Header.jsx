    ...
    <header className="p-4 sticky top-0  bg-gray-800 shadow-2xs z-50 shadow-blue-200">
      <div className="container mx-auto flex justify-between items-center">
        <div className="flex items-center gap-3">
          <div onClick={logoClickHandle} className="cursor-pointer">
            <img
              src={logo}
              alt="Website Logo"
              className="rounded-full h-14 w-14 mix-blend-plus-lighter"
            />
          </div>
        ...
        <div className="flex items-center gap-4 relative">
          {!isAuthPage && !user && (
            <Link to="/login">
              <button className="px-4 py-2 bg-blue-500 text-white font-semibold rounded-lg shadow-md transition-transform duration-200 hover:scale-105 hover:bg-blue-600 active:scale-95">
                Login
              </button>
            </Link>
          )}
          ...
          {user && (
            <div className="relative" ref={profileRef}>
              ...
              >
                ...
                <Link to={"/wishlist"}>
                  <button className="mt-4 w-full bg-blue-500 text-white font-semibold py-2 rounded-lg transition-transform duration-200 hover:scale-105 hover:bg-blue-800 active:scale-95">
                    Wishlist
                  </button>
                </Link>
